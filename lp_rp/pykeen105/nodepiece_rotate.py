...
class NodePieceRotate(Model):
    ...
    def __init__(self,
        ...
        ###### 
        self.anchor_embeddings = VariableSizedEmbedding(embedding_sizes=self.anchors_reduced_embeddings, embedding_dimension=self.embedding_dim, device=self.device)
