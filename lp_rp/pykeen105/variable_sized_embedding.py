...
class VariableSizedEmbedding(nn.Module):
    ...
    def __init__(self, embedding_sizes: torch.Tensor, embedding_dimension: int, hid_dim: int, device: torch.device) -> None:
        ...
        # TODO: for each of these unique sizes, make a normal Embedding, containing count embeddings, store them in a list
    ...
    def forward(self, input: torch.Tensor):
        ...
        for MLP_index, (start, end) in enumerate(zip(self.start_offsets, self.end_offsets)):
            ...
            # print(self.anchor_embeddings[MLP_index].device)
